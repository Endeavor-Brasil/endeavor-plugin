...
Apresente o cardápio cru, sem chamar o MCP, como **lista numerada** (1 a 6). Não use popup de
escolha para este menu: são seis opções e a tool de escolha só comporta quatro por pergunta.
