...
- 🎙️ **Sessão simulada com um mentor** — converse com uma versão IA de mentores da rede, treinada
...
- Fallback sem botões: liste as opções numeradas (1, 2, 3, 4) e peça o número.
