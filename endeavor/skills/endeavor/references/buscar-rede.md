...
`buscar_rede`, faz o polling e apresenta os perfis seguros. Voz do founder, separador "|", nunca
travessão.
...
3. Polling com `consultar_analise(job_id)`: enquanto começar com "⏳", aguarde 20-30s e chame de novo.
